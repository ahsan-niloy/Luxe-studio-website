export default function Subheading({ children, className = "" }) {
  return (
    <div
      className={`relative flex flex-row text-[#717342] mt-[4rem] sm:mt-[2rem] md:mt-[8rem] mb-[1rem] md:mb-[2rem] px-[5vw] md:px-[10vw] w-full h-[60px] sm:h-[130px] overflow-hidden ${
        className || ""
      }`}
    >
